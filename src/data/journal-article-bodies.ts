...
> = {
  "field-note-takeo-chawan-kiln": {
    ...
    zh: [
      ...
      "有田燒以佐賀縣有田町為中心，自1610年代前後延續至今，是日本磁器的起源之一，亦為日本國家指定傳統工藝品。伊萬里燒本是從伊萬里港出口海外的磁器總稱，內容多為有田及近郊窯元的作品，與其說是另一種技法，不如說是流通上的稱呼。波佐見燒在長崎縣波佐見町，與有田同屬一系，江戶以降以日常器的大量生產聞名。武雄燒則是武雄市的地方燒物，有四百年以上歷史，磁器與陶器並存，至今仍有九十處以上窯元。",
