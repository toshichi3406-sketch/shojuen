...
> = {
  "field-note-takeo-chawan-kiln": {
    ...
    en: [
      ...
      "One episode showed his character clearly. A woman visited with a child of four or five. When the child chose a piece to buy, the master joked: 'In a year, break it — then you can come buy another. Then you can come see me again!' — using the familiar nickname he calls himself around children. Pottery is consumable in a sense, yet people rarely replace it unless it breaks — knowing that, he said it lightly, in jest.",
      "The child took him seriously, eager to see him again — the potter the child called Ojichan, after that same nickname — and really tried to break it — but couldn't. The child named the piece '2020' and hung it on the wall. The next year they came to tell the master they had come to buy the '2021' piece — and he teared up hearing it. It shows how he values human connection above all; pottery exists for that bond, yet he also honors the vessel itself. Shojuen, too, connects people through trade; products are the means. So it matters not only to exchange money, but to put feeling into what we sell — I felt that again.",
    ],
    zh: [
