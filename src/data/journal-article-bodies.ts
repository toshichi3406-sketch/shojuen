...
> = {
  "field-note-takeo-chawan-kiln": {
    ja: [
      "当園では、これから抹茶椀も取り扱っていこうと考えています。その背景には、佐賀が日本でも有数の陶磁器の産地であるという事実があります。有田焼、伊万里焼、波佐見焼は磁器として知られ、武雄焼は陶器と磁器の両方を生む地場——名前は異なりますが、いずれも長い歴史と高い技術を持つ焼き物の世界です。今回、松壽園が抹茶椀の窯元として向き合うことにしたのが、佐賀・武雄のこの窯元です。",
      ...
      "今回訪ねた窯元は、有田焼の系譜を受け継ぐ呼び名を持ちながら、武雄で器を手がける工房です。伊万里や波佐見の産地そのものではなく、武雄の地で日々の器をつくる現場——花器を専門としながら、手ろくろの抹茶碗や茶道具にも取り組む一軒です。武雄は陶器と磁器の両方がある産地。ここでつくられる器は流通上「有田焼」と呼ばれることもありますが、磁器だけに限りません。有田・伊万里の磁器は、江戸時代から海外にも渡り、日本を代表する輸出陶磁器として名を残しました。磁器の高峰と、武雄のような日用の焼き物が近接する——佐賀は、その両方を一度に見られる国内でも稀な産地です。",
    ...
    en: [
      ...
      "The workshop we visited carries the Arita name in its lineage while making vessels in Takeo — not in Imari or Hasami proper, but as a daily workshop on Takeo ground, specializing in flower vases while also making hand-thrown matcha bowls and tea utensils. Takeo is a region where stoneware and porcelain coexist; pieces here may be sold under the Arita label, but they are not porcelain by default. Arita and Imari porcelain were exported from the Edo period onward, among Japan's defining ceramic exports. High porcelain and everyday ware from places like Takeo sit side by side — Saga is one of the few regions in Japan where you can see both at once.",
    ...
    zh: [
      "松壽園準備經手抹茶碗。佐賀是日本數一數二的陶磁器產地——有田燒、伊萬里燒、波佐見燒以磁器聞名，武雄燒則同時涵蓋陶器與磁器。名稱各異，卻都是歷史悠久、技術深厚的燒物世界。這次，松壽園選擇與佐賀、武雄的這座窯元合作抹茶碗。",
      ...
      "此次造訪的窯元，承襲有田燒系譜的名稱，在武雄製作器物——並非伊萬里或波佐見產地本身，而是在武雄這片土地上日常制器的工房；專門花器，同時也以手拉坯製作抹茶碗與茶道具。武雄是陶器與磁器並存的產地，這裡的器物流通上或有「有田燒」之稱，但不限於磁器。有田、伊萬里的磁器自江戶時代起出口海外，是日本代表性的輸出陶磁器。磁器的高峰與武雄這類日用燒物彼此毗鄰——佐賀是國內少見、能同時看見兩者的產地。",
