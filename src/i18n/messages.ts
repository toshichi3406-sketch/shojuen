...
const ja: Messages = {
  ...
  chawanPage: {
    ...
    colors: {
      hakuji: { label: "白釉", blurb: "澄んだ白の釉。抹茶の緑を鮮やかに映す。" },
      sometsuke: { label: "藍絵", blurb: "呉須の藍で描く絵付け。端正な景色。" },
      seiji: { label: "青釉", blurb: "淡い青緑の釉。静かで奥行きのある景色。" },
      ruri: { label: "瑠璃釉", blurb: "深い藍一色。緑との鮮烈な対比。" },
      kuro: { label: "黒釉", blurb: "艶やかな黒と鉄釉。泡のきめが際立つ。" },
...
const en: Messages = {
  ...
  chawanPage: {
    ...
    colors: {
      hakuji: { label: "White glaze", blurb: "A clear white glaze that shows matcha's green brightly." },
      sometsuke: { label: "Blue brushwork", blurb: "Cobalt-blue painted decoration — quiet and poised." },
      seiji: { label: "Blue-green glaze", blurb: "Pale blue-green glaze — quiet and deep." },
      ruri: { label: "Lapis glaze", blurb: "Deep blue in striking contrast with green." },
      kuro: { label: "Black glaze", blurb: "Lustrous black and iron glaze; foam stands out." },
...
const zh: Messages = {
  ...
  chawanPage: {
    ...
    ctaContact: "聯絡頁面",
    colors: {
      hakuji: { label: "白釉", blurb: "澄澈的白釉，最能映出抹茶的翠綠。" },
      sometsuke: { label: "藍繪", blurb: "以吳須之藍描繪，端正的景色。" },
      seiji: { label: "青釉", blurb: "淡青綠釉，寧靜而有層次。" },
      ruri: { label: "瑠璃釉", blurb: "深藍一色，與綠形成鮮明對比。" },
      kuro: { label: "黑釉", blurb: "潤澤的黑與鐵釉，凸顯泡沫的細緻。" },
